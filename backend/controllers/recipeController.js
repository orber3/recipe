...
const createRecipe =asyncHandler(async (req,res) =>  {
    ...
    const {name , cookingTime , catagory , description  , ingredients , directions , user} = req.body 

                  const recipe = new Recipe({ 
            name , cookingTime , catagory , description ,ingredients , directions , user
        })
